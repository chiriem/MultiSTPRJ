...
<head>
    ...
    <script type="text/javascript">
        ...
        function doEdit() {
            if ("<%=edit%>" == 2) {
                location.href = "/Contact/ContactEditInfo?nSeq=<%=CmmUtil.nvl(rDTO.getContact_seq())%>";
        ...
        function doDelete() {
            if ("<%=edit%>" == 2 || "<%=edit%>" == 1) {
                if (confirm("작성한 글을 삭제하시겠습니까?")) {
                    ...
                    f.action = "/Contact/ContactDelete";
                    f.submit();
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded p-4">
                <form id="f" method="post">
                    <input type="hidden" name="nSeq" value="<%=CmmUtil.nvl(rDTO.getContact_seq())%>"/>
                </form>
                <div class="row mb-3">
