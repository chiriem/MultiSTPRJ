...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit(f) {
            ...
            // var ContactCheck = false; //체크 여부 확인 변수
            // for (var i = 0; i < f.ContactYn.length; i++) {
            //     if (f.ContactYn[i].checked) {
            //         ContactCheck = true;
            //     }
            // }
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded p-4">
                <form name="f" method="post" action="/Contact/ContactInsert" target="ifrPrc"
